 ...
 * Generated at: 2017-10-27 09:27:08 UTC
...
public final class consultaAves_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\tapp.controller('consultaAves', [ '$scope', '$http', '$rootScope',\r\n");
      out.write("\t\t\tfunction($scope, $http, $rootScope) {\r\n");
      out.write("\t\t\t\tlistarAvesNombre($scope, $http, $rootScope);\r\n");
      out.write("\t\t\t} ]);\r\n");
      out.write("\r\n");
      out.write("\tfunction listarAvesNombre($scope, $http, $rootScope) {\r\n");
      out.write("\t\t$scope.listarAvesNombre = function(dsnombreComun, dsnombreCientifico) {\r\n");
      out.write("\t\t\tif (dsnombreComun === undefined || dsnombreCientifico === undefined) {\r\n");
      out.write("\t\t\t\talert(\"Ingrese Nombre Comun o Nombre Cientifico para realizar la busqueda o letras claves\");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t$http({\r\n");
      out.write("\t\t\t\turl : '/iasAvesWeb/AvesServicio/listarAvesNombre',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\talert(\"Error cargando el servicio : /iasAvesWeb/AvesServicio/listarAvesNombre, causa: \"\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t<div ng-app=\"iasAvesWeb\" ng-controller=\"consultaAves\" class=\"container\">\r\n");
      out.write("\t\t<h2>Consulta de Aves</h2>\r\n");
      ...
      out.write("\t\t\t\t\t\tng-click=\"listarAvesNombre(dsNombreComun,dsNombreCientifico)\">Consultar</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</form>\r\n");
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr ng-repeat=\"ave in listaAvesNombre\">\r\n");
